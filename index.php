...
<font size="+3"><center>
  <strong><i>Welcome to Argjentina Bike Sklep</i></strong>
</center></font><br>

    <form action="lookup.php" method = "GET">

        Type Product to look for: <input type="text" name="search_field" required>
...
<div align="left"><p style="padding: 10px;"><i><font size="+1"><b><span style="color: CornflowerBlue">About us</span></b></font></i><br><br>

  <strong>Our shop</strong> - If you're looking for the best range of cycles which offer high quality and exceptional value for money you can be assured of finding the best here at Argjentina Bike Sklep. We have bikes to suit all types of riders; from road bikes to professional cycling hybrids, we match cycles to riders to provide the optimum choices.<br><br>
