    ...
    <center><table width="951" border="1">
            ...
            <tr>
                ...
                <td width="711" valign="top" style="background-color: #FFFFFF">
                    ...
                    $prod_name = filter_input(INPUT_POST, 'view_prod_name', FILTER_SANITIZE_STRING);


                    //Query request
                    $query = array('name' => $prod_name);

                    //Mongo DB Cursor obj
                    $prod_look = $db->catalog->findOne($query);


                    ?>


                    <div align="left"><p style="padding: 10px;"><i><font size="+1"><b><span
                                            style="color: CornflowerBlue">Our bikes</span></b></font></i><br><br>

                            <!-- Product Loop Script Alpha -->

                            <!-- Generated Content using Jaceks Layout HTML-->
                            <strong><?php echo $prod_look['name'] ?></strong><br>
                            <img src="<?php echo $prod_look['image_url'] ?>" height="316" width="500"><br>

                            <strong>Stock: <?php echo $prod_look['stock_count'] ?></strong><br><br>

                            <strong>About this product</strong>
                        <p><?php echo $prod_look['description'] ?></p><br><br>

                        <strong>Delivery</strong> - Fast and Free<br><br>

                        <strong>Price</strong> - £<?php echo $prod_look['price'] ?><br><br>
                ...
                <td width="240" valign="top" background="images/nav_background.jpg">
                    ...
                    <span style="color: CornflowerBlue"><b> ------</b></span> <span
                        style="color: CornflowerBlue"><b>R</b></span><span style="color: white"><b>ecommended</b></span>
                    <span style="color: CornflowerBlue"><b>B</b></span><span style="color: white"><b>ikes</b></span>
                    <span style="color: CornflowerBlue"><b>------ </b></span><br><br>
    ...
    <center><table width="951" border="1">
            ...
            <tr>
                ...
                <td width="711" valign="top" style="background-color: #FFFFFF">
                    ...
                    <h1> Please Log in to view Admin View</h1>
